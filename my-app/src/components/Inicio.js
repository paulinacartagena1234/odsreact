  ...
  return (
    <div className="inicio">
      <header>
        ...
        <p className="text">
          El funcionamiento del software Analizador ODS se basa en la evaluación
          y clasificación de documentos en función de su alineación con los
          ...
          {[...Array(17)].map((_, index) => {
            ...
            return (
              ...
              >
                ...
                />
                {tooltipIndex === index && (
                  <div className="tooltip">{odsInfo[index]}</div>
                )}
              </div>
            );
          })}
